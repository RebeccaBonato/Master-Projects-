...
The classification is multi-class (5 classes present) and multi-label (each ECG can be assigned more than one class). Each ECG can be classified as normal ECG, myocardial infarction, ST/T change, conduction disturbance and/or hypertrophy. The parameters monitored to assess classification are accuracy, precision, recall and hamming loss. 
